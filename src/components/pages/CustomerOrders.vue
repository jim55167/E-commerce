        ...
        <div class="modal fade" id="productModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    <img style="margin: 0 auto; display: flex" :src="product.imageUrl" class="img-fluid" alt="">
            ...
            <form @submit.prevent="createOrder">
              ...
              <validation-provider rules="required|email" v-slot="{ errors, classes }">
                <div class="form-group">
                  ...
                  <input id="email" type="email" name="email"
                    v-model="form.user.email" class="form-control" :class="classes" placeholder="請輸入Mail">
                  <!-- 錯誤訊息 -->
              ...
              <validation-provider rules="required" v-slot="{ errors, classes }">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="此欄位" id="username"
                    :class="classes" v-model="form.user.name" placeholder="請輸入收件姓名">
                  <span class="invalid-feedback">{{ errors[0] }}</span>
                </div>
              </validation-provider>
              ...
              <validation-provider rules="required|numeric" v-slot="{ errors, classes }">
                <div class="form-group">
                  ...
                  <input type="tel" class="form-control"  :class="classes" 
                    id="usertel" v-model="form.user.tel" placeholder="請輸入電話" name="此欄位">
                  <span class="invalid-feedback">{{ errors[0] }}</span>
                </div>
              </validation-provider>
              ...
              <validation-provider rules="required" v-slot="{ errors, classes }">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="此欄位" id="useraddress" v-model="form.user.address"
